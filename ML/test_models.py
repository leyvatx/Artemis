...
try:
    ...
    if rf_model.n_features_in_ == 9:  # 9 features con estrés
        print("   ✅ Modelo entrenado con features de estrés")
    elif rf_model.n_features_in_ == 6:  # Solo 6 features básicas
        print("   ⚠️ Modelo SIN features de estrés - REGENERAR notebook")
...
if has_stress_features and rf_model.n_features_in_ == 9:
    ...
    print("⚠️ MODELOS DESACTUALIZADOS")
    print("⚠️ NECESITAS EJECUTAR model_training.ipynb COMPLETO")
